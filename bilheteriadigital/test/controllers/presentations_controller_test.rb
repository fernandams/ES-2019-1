...
class PresentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presentation" do
    assert_difference('Presentation.count') do
      post presentations_url, params: { presentation: { date: @presentation.date, event_id: @presentation.event_id, price: @presentation.price, time: @presentation.time } }
    end
  ...
  test "should update presentation" do
    patch presentation_url(@presentation), params: { presentation: { date: @presentation.date, event_id: @presentation.event_id, price: @presentation.price, time: @presentation.time } }
