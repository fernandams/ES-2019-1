...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { due_date: @credit_card.due_date, number: @credit_card.number, sec_code: @credit_card.sec_code, user_id: @credit_card.user_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { due_date: @credit_card.due_date, number: @credit_card.number, sec_code: @credit_card.sec_code, user_id: @credit_card.user_id } }
